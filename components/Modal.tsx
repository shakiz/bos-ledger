...
export default function Modal({ children, open, onClose }: { children: React.ReactNode; open: boolean; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-xl shadow-md z-10 w-full max-w-full sm:max-w-3xl md:max-w-4xl lg:max-w-6xl border border-slate-200 max-h-[90vh] flex flex-col">
