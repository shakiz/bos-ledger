    ...
    <div className="relative">
      ...
      <div className="md:hidden">
        ...
        <div ref={scrollRef} className="flex gap-3 py-2 overflow-x-auto px-4">
          {dates.map(d => (
            <div
              key={d}
              className="min-w-[170px] bg-slate-50 border border-slate-200 rounded-xl p-2 shadow-sm relative group cursor-pointer hover:shadow-md transition-shadow"
      ...
      <div className="hidden md:grid md:grid-cols-5 gap-3 py-2">
        {dates.map(d => (
          <div
            key={d}
            className="bg-slate-50 border border-slate-200 rounded-xl p-2 shadow-sm max-w-[220px] relative group cursor-pointer hover:shadow-md transition-shadow"
            onClick={() => setOpenDate(d)}
          >
            {/* Delete button */}
            <button
